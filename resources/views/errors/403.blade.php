{{--
    Forbidden (WP6). The wording is fixed: the exception message is never shown,
    so a missing page and a hidden one cannot be told apart from the text.
--}}
<x-layouts.auth title="You can't open this page">
        ...
        <main class="surface-subtle flex flex-col items-center px-4 py-8 sm:px-8 sm:py-12 lg:justify-center">
            <div class="w-full max-w-[26rem] space-y-6 sm:card sm:p-8">
                <div class="space-y-1.5">
                    <h1 class="text-2xl font-semibold tracking-tight">You can't open this page</h1>
                    <p class="text-fg-muted">Your account doesn't have access to it. If you think it should, ask an admin.</p>
                </div>
